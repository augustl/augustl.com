...
* **Organizational Complexity**. Measures number of developers working on the module, number of ex-developers that _used_ to work on the module but no longer do, how big a fraction of the organization as a whole that works or has worked on the module, the distance in the organization between the developer and the decision maker, etc.
